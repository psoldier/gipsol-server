class Questions < Cuba
    ...
    define do
      ...
      on "new" do
        ...
        render("questions/new", question: question, current_section: "questions")
      end

      on post, root do
        question_creation = Filters::QuestionCreation.new(req.params["question"])
        begin
          if question_creation.valid? && Question.create!(question_creation.attributes)
            ...
            render("questions/new", question: Question.new(question_creation.attributes), current_section: "questions")
          end
        rescue => e
          session[:error] = "Error #{e.message} "
          render("questions/new", question: Question.new, current_section: "questions")
        end
      end
      ...
      on ':id' do |id|
        ...
        on put do
          on root do
            question_update = Filters::QuestionUpdate.new(req.params["question"])
            begin
